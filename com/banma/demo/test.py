...
# # c= np.dot(a1,b1)
# # print(c)
# # b2=np.matrix.transpose(b1)
# # print(b2)
# # def _foo_(self,first, second, third, *therest):
# #     print("First: %s" % first)
# #     print("Second: %s" % second)
# #     print("Third: %s" % third)
# #     print("And all the rest... %s" % list(therest))
# #
# # _foo_("hello","world",'hi',[1,2],'ji','hg')
#
# # Example:
# import re
...
# #         else:
# #             print("Pass")
# # pattern = r".*?.com" # Your pattern here!
# # test_email(pattern)
#
...
#
# # import json
# # json_string =json.dumps({'Jake':1, 'John':2, 'Eric':3})
